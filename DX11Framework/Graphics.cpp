...
{
	Logs::Debug("Initialize Graphics"); // “естовый лог
...
{
	// ѕри Flip_Discard нужно при отображение кадра каждый раз устанавливать Render Targets
	...
	// -------------------------------------------------------------------
	// TODO: ѕеренести в InitializeScene или InitializeScene
	// Setup before draw
	...
	deviceContext->OMSetBlendState(blend_state.Get(), NULL, 0xFFFFFFFF);
...
bool Graphics::InitializeDirectX(HWND hWnd)
{
	try {
		...
		rasterizer_desc.CullMode = D3D11_CULL_MODE::D3D11_CULL_NONE; // ƒл€ того что бы не рендерилась задн€€ часть при риосвании против часовой трелки(короче если нормаль смотрит от нас)
		//rasterizer_desc.FrontCounterClockwise = TRUE // ƒл€ того что бы рисовать треугольники против часовой стрелки
